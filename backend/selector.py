...
from .groq_assistant import run_assistant
from .local_selector import SUPPORTED_LANGS, run_local_assistant

VALID_MODES = ("local", "groq")
...
def get_supported_langs() -> list[str]:
    ...
    only covers a couple of languages, the Groq-backed LLM understands every
    dataset language. Used to keep the frontend from offering a language that
